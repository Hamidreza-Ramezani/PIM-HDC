...
#make clean >/dev/null
#make  SAMPLES_IN_MRAM=1 HDC_MAX_INPUT=1900 NR_DPUS=1024 NR_TASKLETS=18 SHOW_DPU_LOGS=0 >/dev/null
#sudo ./pim_hdc -i $dataset_path/large256-data.bin


#make clean >/dev/null
#make  SAMPLES_IN_MRAM=1 HDC_MAX_INPUT=960 NR_DPUS=512 NR_TASKLETS=18 SHOW_DPU_LOGS=0 >/dev/null
#sudo perf record ./pim_hdc -i $dataset_path/large8-data.bin
#sudo perf report
#sudo perf stat -e cache-misses,cache-references ./pim_hdc -i $dataset_path/large8-data.bin
